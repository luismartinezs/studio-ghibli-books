        ...
        return (
            <section id='featured'>
                ...
                <div class='mask d-flex align-center justify-center'>
                    ...
                    <div id='featuredContainer' class='d-flex align-center justify-center text-center'>
...
class Popular extends Component {
    render() {
        return (
            <section id='popular' class='boxes-wrapper d-flex justify-center'>

                <div id='popular-container' class='boxes-container d-flex d-col justify-center align-center'>

                    <h2>Most popular</h2>
                    <ul id='popularList' class='boxes-list d-flex justify-center'>

                        <li class='boxes-list-item text-center'>
...
class Categories extends Component {
    render() {
        return (
            <section id='categories' class='d-flex d-col align-center justify-center w100'>

                <div id='categories-container' class='d-flex d-col justify-center align-center'>

                    <h2>Categories</h2>
                    <ul id='categoriesList' class='d-flex justify-center align-baseline w100'>

                        <li class='categories-list-item text-center d-flex d-col justify-center align-center'>
...
class Newsletter extends Component {
    render() {
        return (
            <section id='newsletter' class='d-flex justify-center align-center w100'>

                <div id='newsletterContainer' class='d-flex d-col justify-center align-center'>
                    ...
                    <p id='spamMsg' class='text-center'>
